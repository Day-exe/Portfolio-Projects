        ...
        public static void main(String[] args){
            ...
            while(run = true){
                ...
                if(rChoice != 1 && rChoice != 2 && rChoice != 3 && rChoice != 4 && rChoice != 5 && rChoice != 6 && rChoice != 7 && rChoice != 8 && rChoice != 9 && rChoice != 10){
                    ...
                    RecipeConverter r1 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r2 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r3 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r4 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r5 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r6 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r7 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r8 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r9 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
                    ...
                    RecipeConverter r10 = new RecipeConverter(numIngredients, batchNum, ingredients, quant, measurements);
